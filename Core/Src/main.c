...
#define SPEAKER_SAMPLE_DELAY_US  106  // Speaker sampling delay
...
/* Routine Handling */
void UselessBox_RoutineDecider(void);
void UselessBox_StandardRoutine(void);
void UselessBox_AngryRoutine(void);
void UselessBox_WaveringRoutine(void);
